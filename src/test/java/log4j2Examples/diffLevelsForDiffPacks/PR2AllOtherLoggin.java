package log4j2Examples.diffLevelsForDiffPacks;

import org.apache.logging.log4j.*;

public class PR2AllOtherLoggin {
	...
	private static Logger log = LogManager.getLogger(PR2AllOtherLoggin.class.getName());
